...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		documents.add(
				new Document("positivas", fm.readFileToString("res/lab4/corpus_positives_reviews.txt"), "positive"));
		documents.add(
				new Document("negativas", fm.readFileToString("res/lab4/corpus_negatives_reviews.txt"), "negative"));
		...
		machineLearningHandler.generateTrainingModel("res/lab4/MaxEntTrainFiles.txt");
		...
		MaxentModel trainedMaxentModel = GIS.trainModel(10000, indexer); // 10.000
																		// iterations
