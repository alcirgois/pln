...
public class aMain {
    ...
    // Read reviews and get 1000 most important by idf
        ...
        documents.add(new Document("positivas",fm.readFileToString("res/lab4/corpus_positives_reviews.txt"),"positive"));
        documents.add(new Document("negativas",fm.readFileToString("res/lab4/corpus_negatives_reviews.txt"),"negative"));
